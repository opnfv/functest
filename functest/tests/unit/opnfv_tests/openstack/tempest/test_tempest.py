...
class OSTempestTesting(unittest.TestCase):
    ...
    def test_create_tempest_resources_missing_network_dic(self):
        with mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
            ...
            mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
                       ...
                       return_value=''):
            self.assertEqual(self.tempestcommon.create_tempest_resources(),
    ...
    def test_create_tempest_resources_default(self):
        CONST.tempest_use_custom_images = 'test_image'
        CONST.tempest_use_custom_flavors = 'test_flavour'
        with mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
                        'os_utils.get_keystone_client',
            ...
            mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
                       'os_utils.get_or_create_flavor',
                       return_value=(mock.Mock(), 'flavor_id')):
            self.assertEqual(self.tempestcommon.create_tempest_resources(),
    ...
    def test_generate_test_list_defcore_mode(self, mock_logger_debug):
        ...
        with mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
            ...
            self.assertEqual(self.tempestcommon.
                             generate_test_list('test_verifier_repo_dir'),
                             testcase_base.TestcaseBase.EX_OK)
    ...
    # TODO: apply_tempest_blacklist

    def test_parse_verification_id(self):
        line = "(UUID=test_uuuid) for deployment"
        self.assertEqual(self.tempestcommon._parse_verification_id(line),
                         'test_uuuid')

    # TODO: AttributeError: Mock object has no attribute 'stdout'
    # @mock.patch('functest.opnfv_tests.openstack.tempest.tempest.logger.debug')
    # @mock.patch('functest.opnfv_tests.openstack.tempest.tempest.logger.info')
    # def test_run_verifier_tests(self, mock_logger_info, mock_logger_debug):
    #     self.tempestcommon.OPTION = ''
    #     line = '\} tempest\.\n'
    #     line += 'Starting verification(UUID=test_uuuid) for deployment'
    #     with mock.patch('__builtin__.open', mock.mock_open()), \
    #         mock.patch('functest.opnfv_tests.openstack.tempest.tempest.'
    #                    'os.path.join'), \
    #         mock.patch.object(subprocess, 'Popen',
    #                           autospec=True) as mock_popen:
    #         mock_popen.return_value.stdout.readline.return_value = line

    #         self.tempestcommon.run_verifier_tests()
    #         mock_logger_debug.assert_any_call('Verication UUID: test_uuuid')
