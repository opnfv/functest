...
VIMS_TEST_REPO_DIR=$(cat $config_file | grep -w dir_repo_vims_test | awk 'END {print $NF}')
...
VIMS_TEST_BRANCH=$(cat $config_file | grep -w vims_test_branch | awk 'END {print $NF}')
VIMS_TEST_COMMIT=$(cat $config_file | grep -w vims_test_commit | awk 'END {print $NF}')
...
echo "VIMS_TEST_REPO_DIR=${VIMS_TEST_REPO_DIR}"
...
echo "VIMS_TEST_BRANCH=${VIMS_TEST_BRANCH}"
echo "VIMS_TEST_COMMIT=${VIMS_TEST_COMMIT}"
echo "############################"
