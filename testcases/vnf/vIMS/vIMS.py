...
# Cloudify parameters
VIMS_DIR = REPO_PATH + '/' + \
           ft_utils.get_parameter_from_yaml('general.directories.dir_vIMS')

VIMS_DATA_DIR = \
    ft_utils.get_parameter_from_yaml('general.directories.dir_vIMS_data') + \
    '/'
VIMS_TEST_DIR = \
    ft_utils.get_parameter_from_yaml(
        'general.directories.dir_repo_vims_test') + '/'
DB_URL = \
    ft_utils.get_parameter_from_yaml('results.test_db_url')

TENANT_NAME = \
    ft_utils.get_parameter_from_yaml('vIMS.general.tenant_name')
TENANT_DESCRIPTION = \
    ft_utils.get_parameter_from_yaml('vIMS.general.tenant_description')
IMAGES = \
    ft_utils.get_parameter_from_yaml('vIMS.general.images')

CFY_MANAGER_BLUEPRINT = \
    ft_utils.get_parameter_from_yaml('vIMS.cloudify.blueprint')
CFY_MANAGER_REQUIERMENTS = \
    ft_utils.get_parameter_from_yaml('vIMS.cloudify.requierments')
CFY_INPUTS = ft_utils.get_parameter_from_yaml('vIMS.cloudify.inputs')

CW_BLUEPRINT = \
    ft_utils.get_parameter_from_yaml('vIMS.clearwater.blueprint')
CW_DEPLOYMENT_NAME = \
    ft_utils.get_parameter_from_yaml('vIMS.clearwater.deployment-name')
CW_INPUTS = \
    ft_utils.get_parameter_from_yaml('vIMS.clearwater.inputs')
CW_REQUIERMENTS = ft_utils.get_parameter_from_yaml('vIMS.clearwater.requierments')
