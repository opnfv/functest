 ...
 * Basic & Neutron.Neutron.Networks
   ...
   * Check that the network has been successfully created in OpenDaylight as well by testing the HTTP status code returned
 ...
 * Basic & Neutron.Neutron.Subnets
   ...
   * Check that the subnet has been successfully created in OpenDaylight as well by testing the HTTP status code returned
 ...
 * Basic & Neutron.Neutron.Delete Networks
   ...
   * Check that the network ahs been deleted in OpenDaylight as well
