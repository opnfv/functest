...
from functest.opnfv_tests.vnf.router.test_controller.function_test_exec import(
    FunctionTestExec)
...
class VrouterOnBoardingBase(vnf.VnfOnBoarding):
                ...
                for function_test in function_test_list:
                    ...
                    for test_info in test_list:
                        ...
                        (result, test_result_data) = \
                            self.function_test_vrouter(target_vnf_name,
                                                       test_info)
    ...
    def function_test_vrouter(self, target_vnf_name, test_info):
        ...
        test_exec = FunctionTestExec(self.util_info)
