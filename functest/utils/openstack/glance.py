...
API_NAME = 'image'
API_VERSIONS = {
    "1": "glanceclient.v1.client",
    "2": "glanceclient.v2.client"
}
...
def get_glance_client():
    ...
    glance_client_cls = utils.get_client_class(
        API_NAME,
        get_client_version(),
        API_VERSIONS)
    logger.debug('Instantiating image client: %s', glance_client_cls)

    return glance_client_cls.Client(glance_endpoint,
