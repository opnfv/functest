...
class TempestCommon(testcase_base.TestcaseBase):
    ...
    def __create_tempest_resources(self):
    ...
    def __generate_test_list(self, deployment_dir):
    ...
    def __apply_tempest_blacklist(self):
...
class TempestSmoke(TempestCommon):
    ...
    def run(self):
        ret_val = super(TempestCommon, self).run("smoke")
        if ret_val != 0:
            return -1
