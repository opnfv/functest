...
class ImsVnf(vnf.VnfOnBoarding):
    ...
    def prepare_network(self):
        ...
        self.baton['details']['external_net_name'] = snaps_utils.get_ext_net_name(
            self.snaps_creds)
    ...
    def prepare_floating_ip(self):
        ...
        if len(my_floating_ips) >= 1:
            ...
            self.baton['details']['fip'] = snaps_utils.neutron_utils.create_floating_ip(
    ...
    def clean(self):
        ...
        try:
            ...
            if (self.baton['details'].get('nsr')):
                main_agent.get_agent(
                    "nsr", project_id=self.baton['details']['project_id']).delete(
                        self.baton['details']['nsr'].get('id'))
