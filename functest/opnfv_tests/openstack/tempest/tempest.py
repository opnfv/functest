...
class TempestCommon(testcase_base.TestcaseBase):
    ...
    def parse_verifier_result(self):
        ...
        for line in p.stdout:
            ...
            elif 'Startedat' in new_line:
                time_start = new_line[2]
            elif 'Testsduration,sec' in new_line:
                dur_sec_int = new_line[2]
        ...
        try:
            ...
            self.details = {"timestart": time_start, "duration": dur_sec_int,
                            "tests": int(num_tests),
