...
API_NAME = 'volume'
API_VERSIONS = {
    "1": "cinderclient.v1.client",
    "2": "cinderclient.v2.client",
    "3": "cinderclient.v3.client"
}
...
def get_cinder_client():
    ...
    cinder_client_cls = utils.get_client_class(
        API_NAME,
        get_client_version(),
        API_VERSIONS)
    logger.debug('Instantiating volume client: %s', cinder_client_cls)
    return cinder_client_cls.Client(**creds_cinder)
