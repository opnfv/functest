...
class CliTestCasesTesting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with mock.patch('functest.cli.commands.cli_testcase.tb') as mock_tb:
    ...
    #     with mock.patch.object(self.cli_tests.tiers, 'get_test', return_value=None) as mock_tb_test:
    #         self.cli_tests.show('testname')
    #         mock_click_echo.assert_called_with("The test case '%s' does not exist or is not supported." % 'testname')
