...
|                  |         | rate    |                  |
+==================+=========+=========+==================+
| nosdn            |  12/12  |   100%  | `compass-res-1`_ |
+------------------+---------+---------+------------------+
| odl_l2           |  15/15  |   100%  | `compass-res-2`_ |
+------------------+---------+---------+------------------+
| odl_l3           |  9/12   |    75%  | `compass-res-3`_ |
+------------------+---------+---------+------------------+
| onos             |  15/15  |   100%  | `compass-res-4`_ |
+------------------+---------+---------+------------------+
| openo            |  15/15  |   100%  | `compass-res-5`_ |
+------------------+---------+---------+------------------+
| ocl              |  15/15  |   100%  | `compass-res-6`_ |
+------------------+---------+---------+------------------+
