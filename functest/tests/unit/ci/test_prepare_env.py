...
class PrepareEnvTesting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prepare_env = prepare_env.Environment()
    ...
    def test_check_env_variables_missing_inst_type(self, mock_logger_warn,
        ...
        prepare_env.Environment.check_env_variables()
    ...
    def test_create_directories_missing_dir(self, mock_logger_debug,
        ...
        with mock.patch('functest.ci.prepare_env.os.path.exists',
                ...
                as mock_method:
            prepare_env.Environment.create_directories()
    ...
    def test_source_rc_missing_rc_file(self, mock_logger_warn,
        ...
        with mock.patch('functest.ci.prepare_env.os.path.isfile',
            ...
            prepare_env.Environment.source_rc_file()
    ...
    def test_patch_file(self, mock_logger_debug):
        with mock.patch("__builtin__.open", mock.mock_open()), \
            ...
            CONST.__setattr__('DEPLOY_SCENARIO', 'test_scenario')
            prepare_env.Environment.patch_file('test_file')
    ...
    @mock.patch('functest.ci.prepare_env.yaml.safe_load',
                return_value={'test_scenario': {'tkey': 'tvalue'}})
    @mock.patch('functest.ci.prepare_env.Environment.update_db_url')
        ...
        with mock.patch("__builtin__.open", mock.mock_open()), \
            mock.patch('functest.ci.prepare_env.yaml.dump'), \
                mock.patch.dict('functest.ci.prepare_env.os.environ',
                                ...
                                clear=True):
            prepare_env.Environment.update_config_file()
    ...
    def test_verify_deployment(self):
        with mock.patch('functest.ci.check_deployment.CheckDeployment') \
            ...
            prepare_env.Environment.verify_deployment()
    ...
    def test_install_rally(self, mock_exec, mock_exec_raise, mock_logger_info,
        ...
        prepare_env.Environment.install_rally()
    ...
    def test_install_tempest(self, mock_logger_debug):
        ...
        with mock.patch('functest.ci.prepare_env.'
            ...
            mock.patch('functest.ci.prepare_env.subprocess.Popen',
                ...
                self.assertRaises(Exception):
            prepare_env.Environment.install_tempest()
    ...
    def test_create_flavor(self):
        with mock.patch('functest.ci.prepare_env.'
            ...
            prepare_env.Environment.create_flavor()
    ...
    def test_check_environment_missing_file(self, mock_logger_error,
        ...
        with mock.patch('functest.ci.prepare_env.os.path.isfile',
                        return_value=False), \
                self.assertRaises(Exception):
            prepare_env.Environment.check_environment()
    ...
    @mock.patch('functest.ci.prepare_env.Environment.check_environment')
    @mock.patch('functest.ci.prepare_env.Environment.create_flavor')
    @mock.patch('functest.ci.prepare_env.Environment.install_tempest')
    @mock.patch('functest.ci.prepare_env.Environment.install_rally')
    @mock.patch('functest.ci.prepare_env.Environment.verify_deployment')
    @mock.patch('functest.ci.prepare_env.Environment.update_config_file')
    @mock.patch('functest.ci.prepare_env.Environment.source_rc_file')
    @mock.patch('functest.ci.prepare_env.Environment.create_directories')
    @mock.patch('functest.ci.prepare_env.Environment.check_env_variables')
    @mock.patch('functest.ci.prepare_env.logger.info')
    def test_main_start(self, mock_logger_info, mock_env_var,
        ...
        with mock.patch("__builtin__.open", mock.mock_open()) as m:
            args = {'action': 'start'}
            self.assertEqual(self.prepare_env.main(**args).value, 0)
    ...
    def test_main_no_arg(self, mock_logger_error):
        ...
        self.assertEqual(self.prepare_env.main(**args).value, -1)
