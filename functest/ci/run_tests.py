...
def main(**kwargs):
    ...
    msg = prettytable.PrettyTable(
        header_style='upper', field_names=['env var', 'value'])
    ...
    for testcase in GlobalVariables.EXECUTED_TEST_CASES:
        result = 'PASS' if(testcase.is_successful(
                ) == testcase.EX_OK) else 'FAIL'
        msg.add_row([testcase.case_name, testcase.project_name,
                     _tiers.get_tier_name(testcase.case_name),
                     testcase.get_duration(), result])
