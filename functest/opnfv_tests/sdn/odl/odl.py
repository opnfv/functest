...
class ODLTests(testcase_base.TestcaseBase):
    ...
    netvirt_connectivity_suite_dir = os.path.join(odl_test_repo,
                                     "csit/suites/openstack/connectivity")
    ...
    def main(self, **kwargs):
        dirs = [self.basic_suite_dir, self.neutron_suite_dir, self.netvirt_connectivity_suite_dir]
        try:
