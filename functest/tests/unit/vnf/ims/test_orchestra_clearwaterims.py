...
class OrchestraClearwaterImsTesting(unittest.TestCase):
        ...
        with mock.patch('functest.opnfv_tests.vnf.ims.orchestra_clearwaterims.'
            ...
            mock.patch('functest.opnfv_tests.vnf.ims.orchestra_clearwaterims.'
                       'get_config', return_value={
                           ...
                           'os_image': self.orchestrator['requirements']['os_image'],
                           'flavor': self.orchestrator['requirements']['flavor'],
                           'url': self.orchestrator['bootstrap']['url'],
                           'config': self.orchestrator['bootstrap']['config'],
                           'tenant_images': self.tenant_images,
                           'vnf': self.vnf,
                           'clearwaterims': self.clearwaterims}):
    ...
    @mock.patch(
        'functest.opnfv_tests.openstack.snaps.snaps_utils.neutron_utils.create_floating_ip')
    ...
    # # @mock.patch('functest.opnfv_tests.vnf.ims.orchestra_clearwaterims.get_userdata')
    ...
    #     # with mock.patch.dict(self.orchestrator, details):
    #         orchestra_clearwaterims.get_userdata(self.orchestrator)
