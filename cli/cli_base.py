...
@click.argument('testname', type=click.STRING, required=True)
@click.option('-n', '--noclean', default=False, help='The created '
              'openstack resources by the testcase will not be cleaned '
              'after the execution.')
...
@click.argument('tiername', type=click.STRING, required=True)
@click.option('-n', '--noclean', default=False, help='The created '
              'openstack resources by the tests will not be cleaned '
              'after the execution.')
