...
if __name__ == '__main__':
    parser.add_argument("-t", "--test", dest="test", action='store',
                        help="Test case or tier (group of tests) to be "
                        "executed. It will run all the test if not "
                        "specified.")
    parser.add_argument("-n", "--noclean", help="Do not clean OpenStack "
                        "resources after running each test (default=false).",
                        action="store_true")
