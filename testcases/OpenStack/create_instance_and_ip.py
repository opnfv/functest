...
#
# 0.1: This script is an example of booting a VM and allocating
# a floating ip to it.
...
FLAVOR = ft_utils.get_parameter_from_yaml("example.example_vm_name")
IMAGE_NAME = ft_utils.get_parameter_from_yaml("example.example_vm_name")
