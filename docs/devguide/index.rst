...
per scenario a score is calculated based on the results from the last 50
days. This score is the addition of single test scores. Each test case
...
scoring is teh addition of the scores of all the runnable tests from the
...
require specific hardware configuration. These results however provides
