 ...
 * *connection_check*:  This new test consists in 9 test cases (test duration < 5s)
 checking the connectivity with Glance, Keystone, Neutron, Nova and the external
 network.
 * *api_check*: This new test case verifies the retrieval of OpenStack clients: Keystone, Glance,
