...
from functest.opnfv_tests.openstack.cinder_test import cinder_base, cinder_test 
from functest.utils import env


class CinderVolumeTest(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.check_volume_opperation = cinder_test.VolumeCheck(
    ...
    @mock.patch('snaps.openstack.create_flavor.OpenStackFlavor.create',
                return_value=None)
    @mock.patch('snaps.openstack.create_volume.OpenStackVolume.create',
                 return_value=None)
    ...
    @mock.patch('functest.opnfv_tests.openstack.cinder_test.cinder_test.'
                'VolumeCheck._cinder_test', return_value=True)
    
    @mock.patch('functest.opnfv_tests.openstack.snaps.snaps_utils.'
                'get_ext_net_name', return_value='foo')
    
    def test_volume_data(self, *args):
        # pylint: disable=unused-argument
        os_vm_inst = mock.MagicMock(name='get_console_output')
        os_vm_inst.get_console_output.return_value = 'New data added to the volume'
        ...
        os_vm_inst_2 = mock.MagicMock(name='get_console_output')
        os_vm_inst_2.get_console_output.return_value = 'Found existing data on volume'
        ssh_client_2 = mock.MagicMock(name='get_transport')
        ssh_client_2.get_transport.return_value = None
        scp_client_2 = mock.MagicMock(name='put')
        scp_client_2.put.return_value = None
        ...
        with mock.patch('snaps.openstack.utils.deploy_utils.create_image',
            ...
            self.assertEqual(testcase.TestCase.EX_OK, self.volume_check.run())
