...
floating_ip1=$(neutron floatingip-list | awk 'FNR == 4 {print}' | awk '{print $6}')
floating_ip2=$(neutron floatingip-list | awk 'FNR == 5 {print}' | awk '{print $6}')
floating_ip3=$(neutron floatingip-list | awk 'FNR == 6 {print}' | awk '{print $6}')
floating_ip4=$(neutron floatingip-list | awk 'FNR == 7 {print}' | awk '{print $6}')
