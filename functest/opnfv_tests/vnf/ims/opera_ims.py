...
# Notes for reviewer(s) - very important to read ebfore your review
# replaced all Cleoudify by Heat
# replaced all cloudiy be heat
# replaced all cfy by cw_heat (clearwater heat)
# In attempt to replace CloudifyClient by HeatClient trying to find whare do I get that from snaps-oo or any other options?
# https://gerrit.opnfv.org/gerrit/#/c/39551/2/snaps/openstack/utils/heat_utils.py
# Same way for Execution should we use snaps-oo HeatUtilsCreateComplexStackTests listed in snap-oo imports from FUNCTEST
# What about unitest for stack tesing should we not include those
# https://gerrit.opnfv.org/gerrit/#/c/39551/2/snaps/domain/test/stack_tests.py
# Although I wanted to complete heat orchetsration but in absence of clear picture on snaps and snaps-oo will like some clerifictions
# Before I try one or more patches to get it right - This thus this may go past Release-E 1.0 as is clear
# the scenario currently I am using is os-nosdn-nofeature-ha and targetting compass beause I can not mix JOID/orchestar as they have not 
# included the openims clearwater live tests.
...
# should we replace HeatCleint by https://gerrit.opnfv.org/gerrit/#/c/39551/2/snaps/openstack/utils/heat_utils.py
...
__author__ = "Valentin Boucher <valentin.boucher@orange.com> + Prakash Ramchabdran <prakash.ramchandran@huawei.com>"
