...
for tests on Aarch64 architecture. See `[4]`_ for details
...
separate each feature (e.g. ovs_kvm) 'nofeature' indicates no NFV feature is
deployed
...
src and repos directories are used to hsot third party code used for the tests.
