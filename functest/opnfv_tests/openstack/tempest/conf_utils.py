...
TEMPEST_RESULTS_DIR = os.path.join(ft_constants.FUNCTEST_RESULTS_DIR,
                                   'tempest')
TEMPEST_CUSTOM = os.path.join(ft_constants.FUNCTEST_RESULTS_DIR,
                              ft_constants.FUNCTEST_RESULTS_DIR,
                              'test_list.txt')
TEMPEST_BLACKLIST = os.path.join(ft_constants.FUNCTEST_RESULTS_DIR,
                                 ft_constants.FUNCTEST_RESULTS_DIR,
                                 'blacklist.txt')
TEMPEST_DEFCORE = os.path.join(ft_constants.FUNCTEST_RESULTS_DIR,
                               ft_constants.FUNCTEST_RESULTS_DIR,
                               'defcore_req.txt')
...
def configure_tempest_multisite(deployment_dir, logger):
    """
    Add/update needed parameters into tempest.conf file generated by Rally
    """
