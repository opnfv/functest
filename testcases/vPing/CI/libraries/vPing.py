...
def main():
    ...
    network_id = functest_utils.get_network_id(neutron_client, NEUTRON_PRIVATE_NET_NAME)
    if network_id == '':
        logger.error("Error while getting the ID of the network '%s'" % NEUTRON_PRIVATE_NET_NAME)
        exit(-1)
