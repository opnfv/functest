...
class Foundation(object):
    ...
    def getdefaultpara(self):
        ...
        self.masterusername = str(CONST.ONOS_onosbench_username)
        self.masterpassword = str(CONST.ONOS_onosbench_password)
        self.agentusername = str(CONST.ONOS_onoscli_username)
        self.agentpassword = str(CONST.ONOS_onoscli_password)
        self.runtimeout = CONST.ONOS_runtimeout
        self.OCT = str(CONST.ONOS_environment_OCT)
        self.OC1 = str(CONST.ONOS_environment_OC1)
        self.OC2 = str(CONST.ONOS_environment_OC2)
        self.OC3 = str(CONST.ONOS_environment_OC3)
        self.OCN = str(CONST.ONOS_environment_OCN)
        self.OCN2 = str(CONST.ONOS_environment_OCN2)
        self.installer_master = str(CONST.ONOS_environment_installer_master)
        self.installer_master_username = \
            str(CONST.ONOS_environment_installer_master_username)
