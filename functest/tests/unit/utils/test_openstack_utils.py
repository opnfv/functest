...
class OSUtilsTesting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env_cred_dict = {'OS_USERNAME': 'username',
        ...
        self.os_environs = {'OS_USERNAME': 'test_username',
                            'OS_PASSWORD': 'test_password',
                            'OS_AUTH_URL': 'test_auth_url',
                            'OS_TENANT_NAME': 'test_tenant_name',
                            'OS_USER_DOMAIN_NAME': 'test_user_domain_name',
                            'OS_PROJECT_DOMAIN_NAME':
                            'test_project_domain_name',
                            'OS_PROJECT_NAME': 'test_project_name',
                            'OS_ENDPOINT_TYPE': 'test_endpoint_type',
                            'OS_REGION_NAME': 'test_region_name'}
        self.os_env_vars = {'username': 'test_username',
