...
CIRROS_AARCH64_IMG_TAG=d161201
...
wget ${CIRROS_REPO_URL}/${CIRROS_AARCH64_TAG}/cirros-${CIRROS_AARCH64_IMG_TAG}-aarch64-disk.img -P ${FUNCTEST_BASE_DIR}/data/
wget ${CIRROS_REPO_URL}/${CIRROS_AARCH64_TAG}/cirros-${CIRROS_AARCH64_IMG_TAG}-aarch64-initramfs -P ${FUNCTEST_BASE_DIR}/data/
wget ${CIRROS_REPO_URL}/${CIRROS_AARCH64_TAG}/cirros-${CIRROS_AARCH64_IMG_TAG}-aarch64-kernel -P ${FUNCTEST_BASE_DIR}/data/
