...
if env.get('VOLUME_DEVICE_TYPE') == 'scsi':
    INPUTS.update(IMAGE_EXTRA_PROP="{'hw_disk_bus': 'scsi', 'hw_scsi_model': 'virtio-scsi'}")
    INPUTS.update(IMAGE_ALT_EXTRA_PROP="{'hw_disk_bus': 'scsi', 'hw_scsi_model': 'virtio-scsi'}")
