...
class Tier:
    ...
    def __str__(self):
        lines = split_text(self.description, 52)

        out = ""
        out += ("+========================================================+\n")
        out += ("| Tier:  " + self.name.ljust(48) + "|\n")
        out += ("+========================================================+\n")
        out += ("| Order: " + str(self.order).ljust(48) + "|\n")
        out += ("| Description:                                           |\n")
        for line in lines:
            out += ("|    " + line.ljust(51) + " |\n")
        out += ("| Test cases:                                            |\n")
...
class TestCase:
    ...
    def __str__(self):
        ...
        out = ""
        out += ("+========================================================+\n")
        out += ("| Testcase:  " + self.name.ljust(44) + "|\n")
        out += ("+========================================================+\n")
        out += ("| Description:                                           |\n")
        for line in lines:
            out += ("|    " + line.ljust(51) + " |\n")
        ...
        out += ("|    - Installer: " + installer.ljust(39) + "|\n")
        out += ("|    - Scenario : " + scenario.ljust(39) + "|\n")
        out += ("|".ljust(57) + "|\n")
        out += ("+--------------------------------------------------------+\n")
        return out
