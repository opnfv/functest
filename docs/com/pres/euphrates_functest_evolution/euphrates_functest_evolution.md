...
#### Until Danube, the unique Functest docker was "produced" from Releng


#### TODO detail Releng CI chain


#### Alpines Functest dockers are now produced on Dockerhub
...
#### TODO
* explain why we moved to docker hub
...
###  Functest evolutions
  * creation of requirements.txt, upper-cpntraints.text
...
## Next steps
  * Still lots of work for Fraser
    * Adaptation to use it for XCI gating
