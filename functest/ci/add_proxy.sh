...
pushd "${1:-/root/functest/images}" > /dev/null

http_proxy=${http_proxy:-http://proxy.rd.francetelecom.fr:8080}
https_proxy=${https_proxy:-${http_proxy:-http://proxy.rd.francetelecom.fr:8080}}
ftp_proxy=${ftp_proxy:-${http_proxy:-http://proxy.rd.francetelecom.fr:8080}}
