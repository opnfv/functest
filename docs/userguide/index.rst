...
and  essential operations of OpenStack functionality over the REST API are
working correctly.

In particular, the following are verfied:

  * Basic operation of the DHCP agent functionality for IP address allocation
  * Basic operation of the Openstack Authentication management functionality
    via the Keystone API
  * Basic operation of the OpenStack Image management functionality via the
    Glance API
  * Basic operation of the OpenStack Block Storage management functionality
    via the Cinder API
  * Basic operation of the OpenStack Networking management functionality via
    the Neutron API
  * Basic operation of the Openstack Compute management functionality via
    the NOVA API
...
on the Public/External network and verify that 2 instances can talk on a Private
Tenant network::
...
The Brahmaputra system release enhance the original Arno system release with
an additional list of customized set of Tempest test cases, which are run.

When executing the Rally command, the customized list of tests is passed in via
a special *--tests-file* command option; first introduced in version 0.1.2 of
the Rally framework.
...
In the Colorado release, the Rally testcases are now now distributed accross
two Tiers:

  * Smoke Tier - Test Case 'rally_sanity'
  * Openstack Tier - Test case 'rally_full'

NOTE: Test case 'rally_sanity' executes a defined set of Rally smoke test cases.
Test case 'rally_full' executes the full defined set of Rally tests.
...
^^^^^^^^^^^^^
**TODO:**
**Stuart Mackie** has been contacted for some overview documentation of the
...
**TODO:**
**Tomi Juvonen** has been contacted for some overview documentation of the
...
**TODO:**
**Luke Hinds** has been contacted for some overview documentation of the
