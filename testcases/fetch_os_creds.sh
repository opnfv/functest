...
# TODO:
# Some rc files promp the user for the password. The idea is to do it automatic
# We need to create our own file which is the same for all installers.
# Important things are:
#   export OS_AUTH_URL="xxxxxx"
