...
The test database is used to collect test results. The architecture and
associated API is described in `[2]`_.
If you want to push your results you just have to use the API at the end of your
script.
