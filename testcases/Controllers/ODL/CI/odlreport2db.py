...
# 
# src: Peter Bandzi https://github.com/pbandzi/parse-robot/blob/master/convert_robot_to_json.py
# 
...
def usage():
    print """Usage:
    get-json-from-robot.py --xml=<output.xml> --pod=<pod_name> --installer=<installer> --database=<Database URL> --scenaro=SCENARIO
...
def main(argv):
    try:
        opts, args = getopt.getopt(argv, 'x:p:i:s:h', ['xml=', 'pod=', 'installer=', 'scenario=', 'help'])
    ...
    tests = json.dumps(data, indent=4, separators=(',', ': '))
