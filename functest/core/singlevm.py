...
class VmReady1(tenantnetwork.TenantNetwork1):
    ...
    def publish_image(self, name=None):
        ...
        if env.get('IMG_EXTRA_PROP'):
            extra_properties.update(env.get('IMG_EXTRA_PROP'))
    ...
    def publish_image_alt(self, name=None):
        ...
        if env.get('IMG_ALT_EXTRA_PROP'):
            extra_alt_properties.update(env.get('IMG_ALT_EXTRA_PROP'))
