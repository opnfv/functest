...
class Onos(OnosBase):
    def __init__(self):
        ...
        self.case_name = 'onos'
        self.log_path = os.path.join(self.ONOSCI_PATH, 'TestON/logs')
    ...
    def run_script(self, testname):
        ...
        """
        cli_dir = os.path.join(self.ONOSCI_PATH, 'TestON/bin/cli.py')
    ...
    def clean_existing_logs(self):
        ...
        for log in log_dir:
            try:
                ...
                logger.error('Error with deleting file %s: %s', log, e.strerror)
