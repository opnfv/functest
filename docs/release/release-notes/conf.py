...
latex_documents = [
    (master_doc, 'FunctestReleaseNotes.tex', u'Functest Release Notes Documentation',
     u'Cédric Ollivier \\textless{}cedric.ollivier@orange.com\\textgreater{}', 'manual'),
]
...
man_pages = [
    (master_doc, 'functestreleasenotes', u'Functest Release Notes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FunctestReleaseNotes', u'Functest Release Notes Documentation',
     author, 'FunctestReleaseNotes', 'One line description of project.',
     'Miscellaneous'),
]
