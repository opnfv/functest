...
def config_loader_mock(config_key):
    if config_key == "energy.energy_recorder_api_url":
        return "http://pod-uri:8888"
    elif config_key == "energy.energy_recorder_api_user":
        return "user"
    elif config_key == "energy.energy_recorder_api_password":
        return "password"
    else:
...
class EnergyRecorderTest(unittest.TestCase):
    ...
    @mock.patch("functest.utils.functest_utils.get_pod_name", return_value="MOCK_POD")
    @mock.patch("functest.utils.functest_utils.get_functest_config", side_effect=config_loader_mock)
    def test_decorators(self, loader_mock=None, pod_mock=None, recorder_mock=None):
    ...
    def test_load_config(self, loader_mock=None, pod_mock=None):
        ...
        self.assertEquals(EnergyRecorder.energy_recorder_api["auth"], ("user", "password"))
        self.assertEquals(EnergyRecorder.energy_recorder_api["uri"], "http://pod-uri:8888/recorders/environment/MOCK_POD")

    @mock.patch("functest.utils.functest_utils.get_functest_config", side_effect=config_loader_mock_no_creds)
    @mock.patch("functest.utils.functest_utils.get_pod_name", return_value="MOCK_POD")
    ...
    @mock.patch("functest.utils.functest_utils.get_functest_config", return_value=None)
    @mock.patch("functest.utils.functest_utils.get_pod_name", return_value="MOCK_POD")
