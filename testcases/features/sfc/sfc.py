...
# This will be deleted when tacker is included in OPNFV installation
    ...
    controller_command = ("sshpass -p r00tme ssh " + ssh_options + " root@10.20.0.2"
    ...
    iptable_command1 = ("sshpass -p r00tme ssh " + ssh_options + " root@10.20.0.2"
                        " ssh " + ip + " iptables -P INPUT ACCEPT ")
    iptable_command2 = ("sshpass -p r00tme ssh " + ssh_options + " root@10.20.0.2"
