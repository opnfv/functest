...
class VPingUserdataTesting(unittest.TestCase):
    ...
    @mock.patch('functest.opnfv_tests.openstack.vping.vping_base.VPingBase')
    def test_vping_userdata(self, mock_logger_debug):
        os_vm_inst = mock.MagicMock(name='get_console_output')
        os_vm_inst.get_console_output.return_value = 'vPing OK'
        with mock.patch(
                'functest.opnfv_tests.openstack.vping.vping_base.VPingBase.'
                'deploy_utils.create_vm_instance'),\
             mock.patch(
                 'functest.opnfv_tests.openstack.vping.vping_base.os.'
                        ...
                        return_value=OpenStackVmInstance(
                            ...
                            VmInstanceSettings(
                                ...
                                port_settings=[PortSettings(
                                    name='foo', network_name='bar')]), None)), \
...
class VPingSSHTesting(unittest.TestCase):
    ...
    @mock.patch('functest.opnfv_tests.openstack.vping.vping_base.VPingBase')
    def test_vping_ssh(self, mock_logger_debug):
        os_vm_inst = mock.MagicMock(name='get_console_output')
        os_vm_inst.get_console_output.return_value = 'vPing OK'
        ...
        with mock.patch(
                               ...
                               NetworkSettings(
                                   ...
                                   subnet_settings=[
                                       SubnetSettings(
                                           name='bar',
                                           cidr='10.0.0.1/24')]))), \
                mock.patch('snaps.openstack.create_flavor.OpenStackFlavor.'
                           'create',
                           return_value=None), \
                ...
                mock.patch('functest.opnfv_tests.openstack.vping.vping_ssh.'
                           'VPingSSH._transfer_ping_script',
                           return_value=True), \
                mock.patch('functest.opnfv_tests.openstack.vping.vping_ssh.'
                           'VPingSSH._do_vping_ssh',
